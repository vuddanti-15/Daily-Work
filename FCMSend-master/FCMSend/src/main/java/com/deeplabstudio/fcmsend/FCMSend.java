...
public class FCMSend {
    ...
    public static class Builder {
        ...
        @SuppressLint("NewApi")
        public FCMSend send() {
            if (SERVER_KEY == null) mFcm.result = "AAAA2Mon9h8:APA91bFpGqf2AqQoK5dTUUcwgE_Ci2PXIgKIYgWPfe2EMh8CrY4DS7vmSengIoeDwO_OZCe0dYgQAooWIEnI1azakxvOlYCtYf-O1YnEFKxgtUe5ZefSF8Idsidm4ypxqoD7g-q9-cE6";
            else {
